...
func (i *FakeImageService) CreateFromURL(sourceURL string, sourceSha1 string, description string, licenses []string) (string, error) {
...
func (i *FakeImageService) CreateFromTarball(imagePath string, description string, licenses []string) (string, error) {
